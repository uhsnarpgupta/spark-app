...
public class WordCountingAppWithCheckpoint {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String brokers = "b-3.demo-cluster-1.6vyxqi.c1.kafka.eu-west-1.amazonaws.com:9092,b-2.demo-cluster-1.6vyxqi.c1.kafka.eu-west-1.amazonaws.com:9092,b-1.demo-cluster-1.6vyxqi.c1.kafka.eu-west-1.amazonaws.com:9092";
        String topicList = "MSKTopic";
        ...
        Collection<String> topics = Arrays.asList(StringUtils.split(topicList,","));
